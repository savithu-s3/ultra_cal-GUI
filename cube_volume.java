 ...
 * @author 2
 */
public class cube_volume extends javax.swing.JFrame {

    /**
     * Creates new form cube_volume
     */
    public cube_volume() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cube_volume.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cube_volume().setVisible(true);
            }
        });
    }
