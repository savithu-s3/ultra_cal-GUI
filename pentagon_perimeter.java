 ...
 * @author 2
 */
public class pentagon_perimeter extends javax.swing.JFrame {

    /**
     * Creates new form pentagon_perimeter
     */
    public pentagon_perimeter() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Topic.setText("Perimeter > Pentagon");
    ...
    private void calculateMouseClicked(java.awt.event.MouseEvent evt) {                                       
        String side_lengthStr = input.getText();
        double side_length = Double.parseDouble(side_lengthStr);
        double perimeter = side_length*5;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pentagon_perimeter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pentagon_perimeter().setVisible(true);
            }
        });
    }
