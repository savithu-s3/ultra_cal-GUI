 ...
 * @author 2
 */
public class pentagon_area extends javax.swing.JFrame {

    /**
     * Creates new form pentagon_area
     */
    public pentagon_area() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Topic.setText("Area > Shapes > Pentagon");
    ...
    private void calculateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calculateMouseClicked
        ...
        double area = ((Math.sqrt(5*(5+2*Math.sqrt(5))))*(side_length*side_length))/4;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pentagon_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pentagon_area().setVisible(true);
            }
        });
    }
