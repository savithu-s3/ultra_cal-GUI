 ...
 * @author 2
 */
public class hexagon_area extends javax.swing.JFrame {

    /**
     * Creates new form hexagon_area
     */
    public hexagon_area() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Topic.setText("Area > Shapes > Hexagon");
    ...
    private void calculateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calculateMouseClicked
        ...
        double area = ((3*Math.sqrt(3)/2)*(side_length*side_length));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hexagon_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hexagon_area().setVisible(true);
            }
        });
    }
