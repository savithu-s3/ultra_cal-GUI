 ...
 * @author 2
 */
public class cylinder_area extends javax.swing.JFrame {

    /**
     * Creates new form cylinder_area
     */
    public cylinder_area() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Topic.setText("Area > Solids > Cylinder");
    ...
    private void calculateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calculateMouseClicked
        ...
        double circ_ar = (3.14*radius*radius)*2;
        double breadth = 2*3.14*radius;
        double area = (height*breadth) + circ_ar;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cylinder_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cylinder_area().setVisible(true);
            }
        });
    }
