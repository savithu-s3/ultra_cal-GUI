 ...
 * @author 2
 */
public class hexagon_perimeter extends javax.swing.JFrame {

    /**
     * Creates new form hexagon_perimeter
     */
    public hexagon_perimeter() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Topic.setText("Perimeter > Hexagon");
    ...
    private void calculateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calculateMouseClicked
        ...
        double perimeter = side_length*6;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hexagon_perimeter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hexagon_perimeter().setVisible(true);
            }
        });
    }
