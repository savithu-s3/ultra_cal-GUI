 ...
 * @author 2
 */
public class tetrahedron_volume extends javax.swing.JFrame {

    /**
     * Creates new form tetrahedron_volume
     */
    ...
    private void initComponents() {
        ...
        Topic.setText("Volume > Tetrahedron");
    ...
    private void calculateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calculateMouseClicked
        ...
        double volume = (side_length*side_length*side_length)/(Math.sqrt(2)*6);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tetrahedron_volume.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tetrahedron_volume().setVisible(true);
            }
        });
    }
