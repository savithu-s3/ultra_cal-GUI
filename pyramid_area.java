 ...
 * @author 2
 */
public class pyramid_area extends javax.swing.JFrame {

    /**
     * Creates new form pyramid_area
     */
    public pyramid_area() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Topic.setText("Area > Solids > Pyramid");
    ...
    private void calculateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calculateMouseClicked
        ...
        double tri_ar = ((height*length)/2)*4;
        double area = (length*length) + tri_ar;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pyramid_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pyramid_area().setVisible(true);
            }
        });
    }
