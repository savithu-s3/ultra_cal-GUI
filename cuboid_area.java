 ...
 * @author 2
 */
public class cuboid_area extends javax.swing.JFrame {

    /**
     * Creates new form cuboid_area
     */
    public cuboid_area() {
        initComponents();
    }
    ...
    private void calculateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calculateMouseClicked
        ...
        double area = ((length*height)*2) + ((width*height)*2) + ((length*width)*2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cuboid_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cuboid_area().setVisible(true);
            }
        });
    }
