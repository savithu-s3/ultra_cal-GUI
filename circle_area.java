 ...
 * @author 2
 */
public class circle_area extends javax.swing.JFrame {

    /**
     * Creates new form circle_area
     */
    public circle_area() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Topic.setText("Area > Shapes > Circle");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(circle_area.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new circle_area().setVisible(true);
            }
        });
    }
